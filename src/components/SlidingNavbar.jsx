        ...
        <div className="md:flex hidden flex-col items-start justify-between w-full sm:p-6">
          <div>
            ...
            <div className="relative">
              ...
              <div
                src={img1}
                className="w-72 h-48 object-cover rounded-none mb-8 absolute top-0 bg-colorSecondary"
              >
                <ImagePlaceholder />
              </div>
            </div>
